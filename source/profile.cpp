    ...
    , m_username(username)
{
    ...
    connect(ui->btnChangePhoto, &QPushButton::clicked, this, &Profile::handleChangePhotoClicked);
...
// ─────────────────────────────────────────────────────────────────
void Profile::handleChangePhotoClicked()
{
...
QString Profile::copyPictureToStorage(const QString &sourceFilePath) const
{
